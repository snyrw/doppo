    ...
    <div style={{ display: "inline-flex", flexDirection: "column", gap: COL_GAP }}>
      ...
      {hasAttnMlp && (
        <div style={{ display: "flex", alignItems: "center", gap: COL_GAP }}>
          ...
          <span style={{ width: HALF_BAR_W, flexShrink: 0, fontSize: 8, textAlign: "center", color: "var(--color-text-muted)", fontFamily: "var(--font-ibm-plex-mono), monospace", letterSpacing: "0.04em" }}>Attn</span>
          <div style={{ width: 4, flexShrink: 0 }} />
          <span style={{ width: HALF_BAR_W, flexShrink: 0, fontSize: 8, textAlign: "center", color: "var(--color-text-muted)", fontFamily: "var(--font-ibm-plex-mono), monospace", letterSpacing: "0.04em" }}>MLP</span>
      ...
      {data.embed_dla != null && (
        <div style={{ display: "flex", alignItems: "center", gap: COL_GAP }}>
          <div style={{ width: Y_LABEL_W, flexShrink: 0, fontSize: 9, fontFamily: "var(--font-ibm-plex-mono), monospace", paddingRight: 4, textAlign: "right", color: "var(--color-text-muted)", fontStyle: "italic" }}>
            emb
          </div>
          {hasAttnMlp ? (
            <>
  ...
  return (
    <div style={{ display: "inline-flex", flexDirection: "column", gap: COL_GAP }}>
      {ranked.map(({ label, val }) => (
        <div key={label} style={{ display: "flex", alignItems: "center", gap: COL_GAP }}>
          <div style={{ width: Y_LABEL_W + 14, flexShrink: 0, fontSize: 9, fontFamily: "var(--font-ibm-plex-mono), monospace", paddingRight: 4, textAlign: "right", color: "var(--color-text-muted)" }}>
            {label}
          </div>
