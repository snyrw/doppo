      ...
      <div style={{ padding: "8px 6px 6px", position: "relative" }}>
        ...
        >
          <g transform={`translate(${PAD.left},${PAD.top})`}>
              ...
              return (
                <g key={i}>
                  ...
                  <text
                    ...
                    style={{ fontFamily: "var(--font-azeret-mono), monospace" }}
                  >
                    {val}
                  </text>
                </g>
            ...
            <text x={0} y={INNER_H + 12} fontSize={7} textAnchor="middle" fill="var(--color-text-muted)" style={{ fontFamily: "var(--font-azeret-mono), monospace" }}>0</text>
            <text x={INNER_W} y={INNER_H + 12} fontSize={7} textAnchor="middle" fill="var(--color-text-muted)" style={{ fontFamily: "var(--font-azeret-mono), monospace" }}>{nLayers - 1}</text>
            <text x={INNER_W / 2} y={INNER_H + 12} fontSize={7} textAnchor="middle" fill="var(--color-text-muted)" style={{ fontFamily: "var(--font-azeret-mono), monospace" }}>layer</text>
