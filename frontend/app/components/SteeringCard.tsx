    ...
    >
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: "10px 12px", gap: 8 }}>
          ...
          {card.streamingText !== undefined && card.streamingText !== "" && (
            <div
              onPointerDown={e => e.stopPropagation()}
              style={{
                fontSize: 11, fontFamily: "var(--font-azeret-mono), monospace",
      ...
      {card.status === "error" && (
        <div style={{ padding: "12px 14px" }}>
          <p style={{ fontSize: 11, color: "#dc2626", margin: 0 }}>✗ {card.error ?? "Unknown error"}</p>
        </div>
      )}
      ...
      {card.status === "result" && card.data && (
        <div onPointerDown={e => e.stopPropagation()} style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ padding: "8px 10px 4px" }}>
            ...
            <div style={{
              fontSize: 11, fontFamily: "var(--font-azeret-mono), monospace", color: "var(--color-text)",
          ...
          <div style={{ padding: "4px 10px 8px" }}>
            ...
            <div style={{
              fontSize: 11, fontFamily: "var(--font-azeret-mono), monospace", color: "var(--color-text-muted)",
              lineHeight: 1.6, maxHeight: 100, overflowY: "auto", background: "var(--color-card)",
              border: "1px solid var(--color-surface-border)", borderRadius: 4,
              padding: "6px 8px", whiteSpace: "pre-wrap", wordBreak: "break-word",
            }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              ...
              <div>
                ...
                {card.data.top_k_steered.map((t, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 4, marginBottom: 3 }}>
                    <span style={{ fontSize: 9, fontFamily: "var(--font-azeret-mono), monospace", color: "var(--color-text)", width: 60, flexShrink: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    ...
                    <span style={{ fontSize: 8, color: "var(--color-text-muted)", fontFamily: "var(--font-azeret-mono), monospace", width: 26, textAlign: "right", flexShrink: 0 }}>
              ...
              <div>
                ...
                {card.data.top_k_baseline.map((t, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 4, marginBottom: 3 }}>
                    <span style={{ fontSize: 9, fontFamily: "var(--font-azeret-mono), monospace", color: "var(--color-text-muted)", width: 60, flexShrink: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {JSON.stringify(t.token)}
                    </span>
                    <div style={{ flex: 1, height: 6, background: "var(--color-surface-border)", borderRadius: 2, overflow: "hidden" }}>
