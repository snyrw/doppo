      ...
      {panelData && (
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 8, gap: 4 }}>
            <span style={{ fontFamily: "var(--font-azeret-mono), monospace", fontSize: 11, fontWeight: 700, color: "var(--color-accent)", background: "var(--color-surface-border)", border: "1px solid var(--color-card-border)", borderRadius: 3, padding: "1px 5px", maxWidth: 90, overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis", flexShrink: 0 }}>
              {panelData.colLabel}
            </span>
            ...
            {panelData.tokens.map((tok, i) => {
              ...
              return (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 5 }}>
                  <span style={{ width: 48, fontFamily: "var(--font-azeret-mono), monospace", fontSize: 9, color: "var(--color-text)", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis", flexShrink: 0, textAlign: "right" }}>
                    {JSON.stringify(tok)}
                  </span>
          ...
          >
            ...
            {hasFilter && (
              <button
                ...
                style={{ fontSize: 9, padding: "1px 5px", background: "var(--color-surface-border)", border: "1px solid var(--color-card-border)", borderRadius: 4, color: "var(--color-accent)", cursor: "pointer", flexShrink: 0, fontFamily: "var(--font-azeret-mono), monospace", lineHeight: 1.4 }}
              >
                {stride > 1 ? `÷${stride}` : "◉"}
              </button>
            )}
            ...
            <div style={{ position: "relative", flexShrink: 0 }}>
              ...
              {strideOpen && (
                ...
                >
                  <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                    <span style={{ fontSize: 9, fontWeight: 600, color: "var(--color-text-muted)", letterSpacing: "0.06em", fontFamily: "var(--font-azeret-mono), monospace" }}>STRIDE</span>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                    <span style={{ fontSize: 9, fontWeight: 600, color: "var(--color-text-muted)", letterSpacing: "0.06em", fontFamily: "var(--font-azeret-mono), monospace" }}>LAYERS</span>
                    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      <span style={{ fontSize: 9, color: "var(--color-text-muted)", fontFamily: "var(--font-azeret-mono), monospace", width: 22 }}>from</span>
                      <button onClick={() => setLayerRange([Math.max(0, rangeFrom - 1), rangeTo])} style={stepperBtn}>−</button>
                      <span style={{ fontSize: 9, fontFamily: "var(--font-azeret-mono), monospace", color: "var(--color-text)", minWidth: 20, textAlign: "center" }}>{rangeFrom}</span>
                      <button onClick={() => setLayerRange([Math.min(rangeTo, rangeFrom + 1), rangeTo])} style={stepperBtn}>+</button>
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      <span style={{ fontSize: 9, color: "var(--color-text-muted)", fontFamily: "var(--font-azeret-mono), monospace", width: 22 }}>to</span>
                      <button onClick={() => setLayerRange([rangeFrom, Math.max(rangeFrom, rangeTo - 1)])} style={stepperBtn}>−</button>
                      <span style={{ fontSize: 9, fontFamily: "var(--font-azeret-mono), monospace", color: "var(--color-text)", minWidth: 20, textAlign: "center" }}>{rangeTo}</span>
                  ...
                  <button
                    onClick={() => { setStride(1); setLayerRange(null); }}
                    style={{ fontSize: 9, padding: "3px 0", background: "none", border: "none", color: "var(--color-text-muted)", cursor: "pointer", textAlign: "left", fontFamily: "var(--font-azeret-mono), monospace" }}
                  >
                    reset
                  </button>
                </div>
                    ...
                    return (
                      ...
                      >
                        {inTokensMode && topToken !== null && (
                          <span style={{ fontSize: 7, fontFamily: "var(--font-azeret-mono), monospace", lineHeight: 1, color: getContrastColor(palette, topProb), maxWidth: "100%", overflow: "hidden", whiteSpace: "nowrap" }}>
                            {topToken}
                          </span>
                        )}
                        {showRankNumber && !inTokensMode && (
                          <span style={{ fontSize: 7, fontFamily: "var(--font-azeret-mono), monospace", lineHeight: 1, color: getContrastColor(palette, cellColorValue), maxWidth: "100%", overflow: "hidden", whiteSpace: "nowrap" }}>
                            {rank}
                          </span>
                        )}
                      </div>
