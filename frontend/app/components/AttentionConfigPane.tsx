        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            <input
              ...
              style={{ flex: 1, border: `1px solid ${usingCustom ? "var(--color-accent)" : "var(--color-card-border)"}`, borderRadius: 6, padding: "6px 8px", fontSize: 11, fontFamily: "var(--font-syne-mono), monospace", color: "var(--color-text)", background: "var(--color-bg)", outline: "none", transition: "border-color 120ms" }}
            />
            <button
